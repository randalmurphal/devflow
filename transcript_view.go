...
func (v *TranscriptViewer) ViewTurn(w io.Writer, turn Turn) error {
	v.writeTurn(w, turn)
	return nil
}

// ViewAssistantOnly displays only assistant turns
func (v *TranscriptViewer) ViewAssistantOnly(w io.Writer, t *Transcript) error {
	v.writeHeader(w, t)
...
func (v *TranscriptViewer) ExportJSON(w io.Writer, t *Transcript) error {
...
func (v *TranscriptViewer) FormatMetaList(w io.Writer, metas []TranscriptMeta) error {
	if len(metas) == 0 {
...
func (v *TranscriptViewer) FormatStats(w io.Writer, stats *RunStatistics) error {
