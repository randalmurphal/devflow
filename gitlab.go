...
// GitLabProvider implements PRProvider for GitLab repositories.
...
func (p *GitLabProvider) CreatePR(ctx context.Context, opts PROptions) (*PullRequest, error) {
...
func (p *GitLabProvider) UpdatePR(ctx context.Context, id int, opts PRUpdateOptions) (*PullRequest, error) {
...
func (p *GitLabProvider) ListPRs(ctx context.Context, filter PRFilter) ([]*PullRequest, error) {
